    ...
    return AnimatedBuilder(
      ...
      child: GridView(
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            ...
            mainAxisSpacing: 20),
        children: [
          for (final each in availableCategories)
            CategoryGridItem(
              category: each,
              onSelectCategory: () {
                _selectCategory(context, each);
              },
            )
        ],
      ),
...
//This code was used to demonstrate how to animate a specific part of a widget and not have to rebuild the whole screen